...
- **[Project Reference Table](docs/project_reference.md)** — exported versioned design table containing locked scoring parameters, threshold rules, temporal settings, and governance decisions
